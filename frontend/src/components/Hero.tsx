  ...
  return (
    <div className="mt-[70px] lg:mt-0 ">
      <div className={style.imgWrapper}>
        ...
        <div className="absolute top-[40%] mx-4 md:mx-16 max-w-[1150px]">
          ...
          <button onClick={handleClick} className="pl-7 pr-4 py-2 md:py-4 rounded font-light  border-2 border-solid border-white  md:text-xl text-white mt-10 flex items-center ">
            Explore Hotels
