...
const Hero = () => {
  return (
    <section className="mt-[95px] relative   md:rounded-3xl overflow-hidden   ">
      
      <div className=" absolute   h-full  md:w-[45%] z-10 p-7 lg:p-10  bg-opacity-60 md:bg-opacity-90  bg-neutral-300  flex flex-col justify-center ">
        <article className="relative lg:-top-10">
          <h1 className="  text-5xl   lg:text-6xl  font-bold ">
            Find Stays & Feel at Home
          </h1>
          <p className="mt-8 text-sm font-medium md:font-normal  ">
