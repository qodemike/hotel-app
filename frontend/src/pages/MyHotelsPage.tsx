...
const MyHotelsPage = () => {
  ...
  if (!hotelData) {
    return (
      <Link
        to="/add-hotel"
        className="flex bg-blue-600 text-white font-bold p-2 hover:bg-blue-500 mt-[80px]"
      >
        Add Hotel
      </Link>
    );
  ...
  return (
    <div className="space-y-5 mt-10 mx-10 ">
      ...
      <div className="grid grid-cols-1 gap-8">
        {hotelData.map((hotel, index) => (
          <div
            ...
            className="flex  flex-col justify-between border border-gray-400 rounded-lg p-8 gap-5"
          >
